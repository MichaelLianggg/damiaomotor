...
#define Motor_id uint32_t
    ...
    typedef struct
    {
        ...
        uint8_t CMD; // Command 0x00: heartbeat
                     ...
                     // 0xEE: communication error (frame contains error code)
                     // Error codes in frame: 8: overvoltage 9: undervoltage A: overcurrent B: MOS overtemp C: motor coil overtemp D: comms lost E: overload
        ...
        uint32_t canId; // ID reported by motor
        uint8_t canData[8];
        uint8_t frameEnd; // frame tail
    } CAN_Receive_Frame;
    ...
    typedef struct can_send_frame
    {
        ...
        uint8_t CMD = 0x03; // command 1: forward CAN frame and expect response 2: handshake, device replies OK 3: non-responsive CAN forward, no status returned
...
#pragma pack()
    ...
    public:
         ...
         *
         * @param Motor_Type motor model type
         * @param Slave_id canId, slave ID (motor ID)
         * @param Master_id host ID, avoid setting Master_id to 0x00
         *
         */
        ...
        /*
         * @brief get motor torque (actual output torque)
         * @return motor torque
         */
        float Get_tau() const { return this->state_tau; }

        /*
         * @brief get limit parameters
         * @return limit_param
         */
 ...
 *
 * Uses USB-to-CAN for communication, Linux provides a virtual serial port
 */
    class Motor_Control
    {
    public:
        ...
        /*
        * @brief construct motor control object
        * @param serial shared pointer to SerialPort
        ...
        */
        ...
        /*
         * @brief enable motor for old firmware. Upgrade recommended.
         * @param motor Motor object
        ...
        */
        ...
        {
            // Position, velocity and torque are linearly mapped from float to signed fixed-point
        ...
        /*
         * @description: Position control mode with torque (position-force hybrid)
         * @param DM_Motor: motor object
         * @param pos: position
         * @param vel: velocity (range 0-10000, see Damiao manual)
         * @param i: current (range 0-10000, see Damiao manual)
         */
        ...
        /*
         * @description: internal function used to decode parameters returned by motor on CAN
         */
        void receive()
        {
            ...
            if(receive_data.CMD == 0x11 && receive_data.frameEnd == 0x55) // receive success
            {
                ...
                else // why was MasterID set to 0x00?
                {
        ...
        /*
         * @description: read motor register parameter, see Damiao manual for register list
         * @param DM_Motor: motor object
         * @param RID: register id example: damiao::UV_Value
         * @return: motor parameter, returns 0 if not found
         */
        ...
        /*
         * @description: change motor param, see Damiao manual for register list
         * @param DM_Motor: motor object
         * @param RID: register id
         * @param data: parameter data (most are float; uint32 types can be provided as integers)
         * @return: bool true or false indicating success
         */
        bool change_motor_param(Motor &DM_Motor,uint8_t RID,float data)
        {
            if(is_in_ranges(RID)) {
                // If the RID expects integer range, convert the provided float to uint32
        ...
        /*
         * @description: save all parameters to motor flash
         * @param DM_Motor: motor object
         * By default parameter changes are not written to flash; use this to persist them.
         */
        ...
        /*
         * @description: change software limit parameters (not motor internal registers)
         * @param DM_Motor: motor object
        ...
        /*
         * @description: change PMAX (position max) in software limits
         * @param DM_Motor: motor object
         * @param P_MAX: position max
         */
